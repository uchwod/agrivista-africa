"""Post-harvest storage advice by crop — Nigeria & West Africa (moisture, structures, pests, aflatoxin)."""
from app.schemas import CropType

STORAGE_TIPS: dict[CropType, list[str]] = {
    CropType.MAIZE: [
...
def get_storage_tips(crop: CropType) -> list[str]:
    """Return post-harvest storage tips for a crop."""
    return STORAGE_TIPS.get(crop, [
